        ...
        function (e, t, n) {
            ...
            function W(e, t) {
                ...
                (i[t] = document.createElement("iframe")),
                    ...
                    (i[t].src = "https://www.youtube.com/embed/".concat(
                        s[t].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2]
                    )),
            ...
            function H() {
                ...
                this.getSourceType = function (o) {
                    if (o.isUrlYoutubeOne(e)) return o("youtube");
                    (t = o), ((n = new XMLHttpRequest()).onreadystatechange = i), n.open("GET", e, !0), n.send();
                };
            }
            function k(e, t, n) {
                var o = e.props,
            ...
            function O(e, t) {
                var n = e.componentsServices.hideSourceLoaderIfNotYetCollection,
                    ...
                    r = (i[t] = document.createElement("div"));
                (r.className = "".concat(d, " ").concat(a, " ").concat(c)),
                    (r.innerHTML = '<div class="fslightbox-loader"><div></div><div></div><div></div><div></div></div>');
                var s = r.firstChild;
                (n[t] = function () {
                    r.contains(s) && r.removeChild(s);
                }),
                    o.sourceWrappersContainer.appendChild(r),
                    (function (e, t) {
                        var n = e.elements,
            ...
            function R(e, t, n, o) {
                ...
                return r.setAttributeNS(null, "class", "".concat(i, "svg-path")), r.setAttributeNS(null, "d", o), i.appendChild(r), e.appendChild(i), i;
            }
            function D(e, t) {
            ...
            function P(e) {
                ...
                (o.className = "".concat(i, "nav")), n.appendChild(o), j(e, o), t.length > 1 && (function (e, t) {
                    ...
                    i.className = "".concat(i, "slide-number-container");
                    ...
                    (n.setSlideNumber = function (e) {
                        ...
                        i.appendChild(document.createTextNode(o.length)),
                        t.appendChild(i),
                        setTimeout(function () {
                ...
                (this.isLightboxFadingOut = !1),
                    (this.runActions = function () {
                        (t.isLightboxFadingOut = !0),
                            ...
                            r.removeListeners(),
                            l.exitFullscreenOnClose && a.isFullscreenOpen && i.exitFullscreen(),
                            setTimeout(function () {
            ...
            function Y(e) {
                ...
                (c.changeTo = function (e) {
                    (p.current = e), u.updateStageIndexes(), r.setSlideNumber(e + 1), l.displaySourcesWhichShouldBeDisplayed();
                }),
                    (c.jumpTo = function (e) {
                        var t = p.current;
                        c.changeTo(e),
            ...
            function J(e) {
                ...
                this.runActionsForEvent = function (e) {
                    ...
                    n.container.contains(n.slideSwipingHoverer) || n.container.appendChild(n.slideSwipingHoverer),
                        ((t = n.container), (r = s), (s = t.classList).contains(r) || s.add(r)),
                        (o.swipedX = q(e) - o.downClientX),
                        u(i.current, "zero"),
                        void 0 !== i.previous && o.swipedX > 0 ? u(i.previous, "negative") : void 0 !== i.next && o.swipedX < 0 && u(i.next, "positive");
                };
                var u = function (e, n) {
                ...
                (n = (t = e).core.classFacade),
                    ...
                    (function (e) {
                        ...
                        (n.attachListeners = function () {
                            document.addEventListener("mousemove", s.listener),
                                document.addEventListener("touchmove", s.listener, { passive: !0 }),
                                document.addEventListener("mouseup", a.listener),
                                document.addEventListener("touchend", a.listener, { passive: !0 }),
                    ...
                    (function (e) {
                        ...
                        (i.runActions = function () {
                            innerWidth < 992 ? (r.maxSourceWidth = innerWidth) : (r.maxSourceWidth = 0.9 * innerWidth),
                ...
                (n.isInitialized = !0),
                    ...
                    (function (e) {
                        ...
                        (n.sourceWrappersContainer = document.createElement("div")),
                            ...
                            n.sourceWrappersContainer.addEventListener("touchstart", t.listener, { passive: !0 });
            ...
            function ne(e) {
                ...
                (r.open = function () {
                    ...
                    (f.current = o),
                        d.isInitialized ? i.dispatch("onShow") : te(e),
            ...
            function le() {
                ...
                var p = Object.keys(fsLightboxInstances);
                window.fsLightbox = fsLightboxInstances[p[p.length - 1]];
            }
            (window.FsLightbox = function () {
                var e = this;
                (this.props = { sources: [], customAttributes: [], customClasses: [], types: [], videosPosters: [], slideDistance: 0.3 }),
                    (this.data = { isInitialized: !1, maxSourceWidth: 0, maxSourceHeight: 0, scrollbarWidth: oe(), isFullscreenOpen: !1 }),
                    (this.slideSwipingProps = { isSwiping: !1, downClientX: null, isSourceDownEventTarget: !1, swipedX: 0 }),
                    (this.stageIndexes = {}),
