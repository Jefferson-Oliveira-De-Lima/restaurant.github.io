(function(t,e){
    ...
    function u(t){
        return (u=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return t.__proto__||Object.getPrototypeOf(t)})(t)
    }

    function l(t,e){
        return (l=Object.setPrototypeOf||function(t,e){return t.__proto__=e,t})(t,e)
    }
    ...
    function h(e){
        return Object.keys(e).map(function(t){return e[t]})
    }
    ...
    function B(){
        var t=n().filter(function(t){return wt(t)});
    ...
    function N(){
        ...
        return function(t){
            ...
            return e
        }(t.concat(e)).filter(function(t){return wt(t)})
    }
    ...
    function _(e,t){
        e.textContent="",t&&(t=(new DOMParser).parseFromString(t,"text/html"),g(t.querySelector("head").childNodes).forEach(function(t){e.appendChild(t)}),g(t.querySelector("body").childNodes).forEach(function(t){e.appendChild(t)}))
    }
    ...
    function lt(t){
        var e=window.getComputedStyle(t),t=parseFloat(e.getPropertyValue("animation-duration")||"0"),e=parseFloat(e.getPropertyValue("transition-duration")||"0");
        return 0<t||0<e
    }
    ...
    var Tt={promise:new WeakMap,innerParams:new WeakMap,domCache:new WeakMap}, Lt=["input","file","range","select","radio","checkbox","textarea"], qt=function(t){
    ...
    function Ut(t,e){
        var n,o,i,r=e.width,a=e.padding,c=e.background,s=e.grow,u=e.position,l=e.toast,d=e.customClass,p=e.showClass,m=e.hideClass,h=e.icon,v=e.iconColor,g=e.iconHtml,y=e.confirmButtonText,w=e.confirmButtonAriaLabel,C=e.confirmButtonColor,k=e.confirmButtonClass,A=e.confirmButtonTextPadding,b=e.confirmButtonDisabled,x=e.confirmButtonStyling,L=e.denyButtonText,q=e.denyButtonAriaLabel,D=e.denyButtonColor,j=e.denyButtonClass,I=e.denyButtonTextPadding,M=e.denyButtonDisabled,H=e.denyButtonStyling,V=e.cancelButtonText,R=e.cancelButtonAriaLabel,N=e.cancelButtonColor,U=e.cancelButtonClass,_=e.cancelButtonTextPadding,F=e.cancelButtonDisabled,z=e.cancelButtonStyling,tt=e.showConfirmButton,et=e.showDenyButton,nt=e.showCancelButton,ot=e.reverseButtons,it=e.showCloseButton,rt=e.closeButtonHtml,at=e.closeButtonAriaLabel,ct=e.loaderHtml,st=e.showLoaderOnConfirm,ut=e.showLoaderOnDeny,lt=e.buttonsStyling,dt=e.focusConfirm,pt=e.focusDeny,ft=e.focusCancel,mt=e.imageUrl,ht=e.imageWidth,gt=e.imageHeight,vt=e.imageAlt,bt=e.timer,yt=e.timerProgressBar,wt=e.input,Ct=e.inputLabel,kt=e.inputPlaceholder,At=e.inputAttributes,xt=e.inputAutoTrim,Bt=e.inputValidator,Pt=e.returnInputValueOnDeny,Et=e.validationMessage,St=e.customContainerClass,Ot=e.footerText,Tt=e.footer,qt=e.didOpen,Dt=e.didClose,jt=e.willOpen,It=e.willClose,Mt=e.onRender,Ht=e.onOpen,Vt=e.onClose,Rt=e.onDestroy,Nt=e.onDismiss,Ut=e.positionSticky,_t=e.containerClass,Pt=e.onBeforeOpen,Ct=e.onAfterClose,kt=e.onAfterCloseClass,At=e.onShow,e={
            confirmButtonText:y, confirmButtonAriaLabel:w, confirmButtonColor:C, confirmButtonClass:k, confirmButtonTextPadding:A, confirmButtonDisabled:b, confirmButtonStyling:x, denyButtonText:L, denyButtonAriaLabel:q, denyButtonColor:D, denyButtonClass:j, denyButtonTextPadding:I, denyButtonDisabled:M, denyButtonStyling:H, cancelButtonText:V, cancelButtonAriaLabel:R, cancelButtonColor:N, cancelButtonClass:U, cancelButtonTextPadding:_, cancelButtonDisabled:F, cancelButtonStyling:z, showConfirmButton:tt, showDenyButton:et, showCancelButton:nt, reverseButtons:ot, showCloseButton:it, closeButtonHtml:rt, closeButtonAriaLabel:at, loaderHtml:ct, showLoaderOnConfirm:st, showLoaderOnDeny:ut, buttonsStyling:lt, focusConfirm:dt, focusDeny:pt, focusCancel:ft, imageUrl:mt, imageWidth:ht, imageHeight:gt, imageAlt:vt, timer:bt, timerProgressBar:yt, input:wt, inputLabel:Ct, inputPlaceholder:kt, inputAttributes:At, inputAutoTrim:xt, inputValidator:Bt, returnInputValueOnDeny:Pt, validationMessage:Et, customContainerClass:St, footerText:Ot, footer:Tt, didOpen:qt, didClose:Dt, willOpen:jt, willClose:It, onRender:Mt, onOpen:Ht, onClose:Vt, onDestroy:Rt, onDismiss:Nt, positionSticky:Ut, containerClass:_t, onBeforeOpen:Pt, onAfterClose:Ct, onAfterCloseClass:kt, onShow:At, width:r, padding:a, background:c, grow:s, position:u, toast:l, customClass:d, showClass:p, hideClass:m, icon:h, iconColor:v, iconHtml:g
        };
        Tt=Object.assign({},e);
        t=Pn(this);
        Ut(this,e);
    ...
    var se={
    ...
    }, de=["allowOutsideClick","allowEnterKey","backdrop","focusConfirm","focusDeny","focusCancel","heightAuto","keydownListenerCapture"], pe=Object.freeze({
        isValidParameter:re, isUpdatableParameter:function(t){
            return -1!==ue.indexOf(t)
        }, isDeprecatedParameter:ae, argsToParams:function(n){
            var o={};
            ...
            return wt(x())
        }, clickConfirm:_t, clickDeny:function(){
            return q()&&q().click()
        }, clickCancel:function(){
            return j()&&j().click()
        }, getContainer:k, getPopup:x, getTitle:P, getContent:E, getHtmlContainer:function(){
            return t($["html-container"])
        }, getImage:S, getIcon:B, getIcons:n, getInputLabel:function(){
            return t($["input-label"])
        }, getCloseButton:R, getActions:I, getConfirmButton:L, getDenyButton:q, getCancelButton:j, getLoader:D, getHeader:M, getFooter:H, getTimerProgressBar:V, getFocusableElements:N, getValidationMessage:T, isLoading:function(){
        ...
        }, stopTimer:Gt, resumeTimer:te, toggleTimer:function(){
            var t=ee.timeout;
    ...
    var Re=["swal-title","swal-html","swal-footer"], Ne=function(t){
        ...
        var n={},t=t.querySelector("swal-image");
        ...
        var n={},t=t.querySelector("swal-icon");
        return t&&(Ye(t,["type","color"]), t.hasAttribute("type")&&(n.icon=t.getAttribute("type")), t.hasAttribute("color")&&(n.iconColor=t.getAttribute("color")), n.iconHtml=t.innerHTML), n
    }, ze=function(t){
    ...
    }, dn=["ArrowRight","ArrowDown","Right","Down"], pn=["ArrowLeft","ArrowUp","Left","Up"], fn=["Escape","Esc"], mn=function(t,e,n){
    ...
    function xn(t,e){
        ...
        }(t), o=s({},se.showClass,e.showClass,n.showClass,t.showClass), i=s({},se.hideClass,e.hideClass,n.hideClass,t.hideClass);
    ...
    function Pn(t){
        var e={
            popup:x(), container:k(), content:E(), actions:I(), confirmButton:L(), denyButton:q(), cancelButton:j(), loader:D(), closeButton:R(), validationMessage:T(), progressSteps:O()
        };
    ...
    var Dn, jn=function(t){
        ...
        hideLoading:fe, disableLoading:fe, getInput:function(t){
            ...
            Object.keys(e).forEach(function(t){
                ...
                params:{
                    value:s({},this.params,e), writable:!1, enumerable:!0
                }
            })
        }, _destroy:function(){
